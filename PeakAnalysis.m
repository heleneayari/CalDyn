...
% Last Modified by GUIDE v2.5 28-Jan-2025 13:41:27
...
switch handles.PK.type
    ...
    case 2
      ...
      %  handles.PK.CalculateParameters(handles.i);
        ...
        set(handles.prop,'string',num2str(handles.PK.prop(handles.i)))
        set(handles.props,'string',num2str(handles.PK.props(handles.i)))
...
% Hints: get(hObject,'String') returns contents of props as text
%        str2double(get(hObject,'String')) returns contents of props as a double
input = str2double(get(hObject,'string'));
handles.PK.props(handles.i:end)=input;
%handles.PK.CalculateParameters(handles.i);
handles.PK.Analyse_MEA(handles.i);
set(handles.prop,'string',num2str(handles.PK.prop(handles.i)))
cla(handles.axes2,'reset')
...
% --- Executes during object creation, after setting all properties.
function props_CreateFcn(hObject, eventdata, handles)
% hObject    handle to props (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
